%   Programa: A_Modelo3_Viga_empotrada_apoyada_damage    
%   Autor: Sergio Vigorra Treviño  
%-------------------------------------------------------------------------
%    Propósito: Este programa modela el comportamiento dinámico de una 
%               viga empotrada-apoyada en la que se ha producido un daño.
%      
...
function [Freq,Egv]=A_Modelo3_Viga_empotrada_apoyada_damage(localiz,damage)
