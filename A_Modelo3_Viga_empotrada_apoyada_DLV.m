%   Programa: A_Modelo3_Viga_empotrada_apoyada_DLV    
%   Autor: Sergio Vigorra Treviño  
%-------------------------------------------------------------------------
%    Propósito: Este programa modela el comportamiento dinámico de una 
%               viga empotrada-apoyada para realizar los cálculos 
%               estáticos necesario para el método DLV.
%      
...
%                         izquierdo y apoyada en el derecho de 5 metros 
%                         de longitud, formada por perfil IPE 80 y 
%                         discretizada en 25 elementos.
%
%-------------------------------------------------------------------------

function es=A_Modelo3_Viga_empotrada_apoyada_DLV(f)
