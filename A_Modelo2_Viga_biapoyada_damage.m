%   Programa: A_Modelo2_Viga_biapoyada_damage    
%   Autor: Sergio Vigorra Treviño  
%-------------------------------------------------------------------------
%    Propósito: Este programa modela el comportamiento dinámico de una 
%               viga biapoyada en la que se ha producido un daño.
%      
%    Entradas: los parámetros de entrada son  la localización del daño
%              y el porcentaje de daño.
%    
%    Salidas: vector con las frecuencias naturales y matriz con los modos
%             de vibración.
%    
%    Detalles del modelo: se trata de una viga biapoyada con una 
%                         longitud de 5 metros y un perfil IPE 80,
%                         discretizada en 25 elementos.
%-------------------------------------------------------------------------

function [Freq,Egv]=A_Modelo2_Viga_biapoyada_damage(localiz,damage)
