%   Programa: A_Modelo1_Viga_biempotrada_DLV    
%   Autor: Sergio Vigorra Treviño  
%-------------------------------------------------------------------------
%    Propósito: Este programa modela el comportamiento dinámico de una 
%               viga biempotrada, para realizar los cálculos estáticos
...
function es=A_Modelo1_Viga_biempotrada_DLV(f)
